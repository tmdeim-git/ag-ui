...
from adk_middleware.utils.converters import (
...
class TestConvertAGUIMessagesToADK:
    ...
    @patch('adk_middleware.utils.converters.logger')
    def test_convert_with_exception_handling(self, mock_logger):
        ...
        with patch('adk_middleware.utils.converters.ADKEvent') as mock_adk_event:
